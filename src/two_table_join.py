...
def two_table_result(table1="first_name",
                     table2="last_name"):
    ...
    def _get_two_table_join_time():
        """
        It joins two table and sends the response time taken by the query
        Returns:
            response time
        """
    ...
    def result(count=1000):
        ...
        _create_all_tables()
        _insert_data(count)
        time_taken = _get_two_table_join_time()
        return time_taken
